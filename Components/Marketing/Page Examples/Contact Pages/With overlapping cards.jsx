    ...
    <div className="bg-white">
      ...
      <main>
        <div className="bg-blue-gray-50">
          ...
          >
            <h2 className="text-3xl tracking-tight font-bold text-blue-gray-900" id="faq-heading">
        ...
        >
          <div className="lg:w-0 lg:flex-1">
            <h2
              className="text-3xl tracking-tight font-bold text-blue-gray-900 sm:text-4xl sm:tracking-tight"

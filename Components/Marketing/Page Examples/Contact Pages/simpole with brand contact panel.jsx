      ...
      <main className="overflow-hidden">
        ...
        <div className="bg-warm-gray-50">
          <div className="py-24 lg:py-32">
            <div className="relative z-10 max-w-7xl mx-auto pl-4 pr-8 sm:px-6 lg:px-8">
              <h1 className="text-4xl font-bold tracking-tight text-warm-gray-900 sm:text-5xl sm:tracking-tight lg:text-6xl lg:tracking-tight">
                Get in touch
              </h1>
        ...
        <section aria-labelledby="offices-heading">
          <div className="max-w-7xl mx-auto py-24 px-4 sm:py-32 sm:px-6 lg:px-8">
            <h2 id="offices-heading" className="text-3xl tracking-tight font-bold text-warm-gray-900">
              Our offices
            </h2>

      ...
      <main>
        ...
        <div className="py-24 bg-gray-50 sm:py-32">
          <div className="max-w-md mx-auto pl-4 pr-8 sm:max-w-lg sm:px-6 lg:max-w-7xl lg:px-8">
            <h1 className="text-4xl leading-10 font-bold tracking-tight text-gray-900 text-center sm:text-5xl sm:tracking-tight sm:leading-none lg:text-6xl lg:tracking-tight">
              Get in touch
            </h1>
        ...
        <div className="bg-grape-400">
          <div className="max-w-md mx-auto text-center py-16 px-4 sm:max-w-2xl sm:py-24 sm:px-6 lg:px-8 lg:py-32">
            <h2 className="text-3xl tracking-tight font-bold sm:text-4xl sm:tracking-tight">
